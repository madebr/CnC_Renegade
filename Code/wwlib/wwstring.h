...
public:
	...
	int __cdecl  Format (const char *format, ...) OPENW3D_PRINTF_VARARG_FUNC(2);
	int __cdecl  Format_Args (const char *format, va_list arg_list ) OPENW3D_PRINTF_VARARG_FUNCV(2);
