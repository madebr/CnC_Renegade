...
#ifndef __IMEMANAGER_WIN32_H__
#define __IMEMANAGER_WIN32_H__

#include "refcount.h"
#include "IMECandidate_win32.h"
#include "Notify.h"
...
class IMEManager :
	...
	protected:
		...
		const IMEManager& operator=(const IMEManager&) = delete;
