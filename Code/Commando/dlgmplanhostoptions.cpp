...
//
////////////////////////////////////////////////////////////////
MPLanHostBasicOptionsTabClass* MPLanHostBasicOptionsTabClass::_mInstance = nullptr;
...
//		Enable_Dlg_Item(IDC_NUM_PLAYERS_EDIT, false);
	...
	if (nic_combobox != nullptr) {

		unsigned int * nics = nullptr;
		int nic_count = 0;
